...
var Clippy = function (_a) {
    ...
    var _b = react.exports.useState(false), mouseOver = _b[0], setMouseOver = _b[1];
    var _c = react.exports.useState(false), copied = _c[0], setCopied = _c[1];
...
var asctime = function (duration) {
    var milliseconds = parseInt("".concat((duration % 1000) / 10), 10), seconds = Math.floor((duration / 1000) % 60), minutes = Math.floor((duration / (1000 * 60)) % 60), hours = Math.floor((duration / (1000 * 60 * 60)) % 24);
    var hours_ = hours < 10 ? '0' + hours : hours;
    var minutes_ = minutes < 10 ? '0' + minutes : minutes;
    var seconds_ = seconds < 10 ? '0' + seconds : seconds;
    var milliseconds_ = milliseconds < 10 ? '0' + milliseconds : milliseconds;
    ...
    var columns = React.useMemo(function () { return [
        {
            ...
            Cell: function (_a) {
                ...
                return (React.createElement(Clippy, { value: value },
                    React.createElement("a", { href: "#/process-definition/".concat(raw.processDefinitionId) }, value)));
            },
        },
        {
            Header: 'Instance ID',
...
var StatisticsProcessTable = function (_a) {
    ...
    var _b = React.useMemo(function () {
        ...
        for (var _i = 0, instances_1 = instances; _i < instances_1.length; _i++) {
            ...
            var duration = instance.durationInMillis;
            ...
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ReactDOM.render(React.createElement(React.StrictMode, null,
                        React.createElement(TableForm, { api: api })), node);
                    return [2 /*return*/];
                });
            }); })();
        },
...
export { processStatistics as default };
